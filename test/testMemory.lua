...
function doGc(event, lineNumber)
    if event == "count" then
        ...
        print(gcinfo())
        runtime:gc()
        print(tostring(runtime:totalMemory() / 1024) .. "   " ..
...
for i = 1, 40000 do luajava.bindClass("java.awt.BorderLayout") end
...
for i = 1, 40000 do luajava.createProxy("java.lang.Runnable", t) end
