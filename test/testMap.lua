...
function map.containsKey(key) return t[key] ~= nil end
...
function map.get(key) return t[key] end
...
for i = 1, 10000 do map.put(i, tostring(i)) end
for i = 1, 10000 do map.put(i, tostring(i + 1)) end
for i = 1, 10000 do map.put(tostring(i), i) end
for i = 1, 10000 do map.put(tostring(i), i + 1) end
